...
import MapsManagement from './MapsManagement';
...
const GameEnvironment = () => {
    ...
    const [filePath, setFilePath] = useState(`${process.env.REACT_APP_IMAGE_BASE_URL}/maps/default.m4v`);
            ...
            <Box className="game-sidebar" width="20%" display="flex" flexDirection="column">
                <Paper>
                    ...
                    >
                        ...
                        <Tooltip title="Cartes">
                            <Tab icon={<MapIcon />} sx={{ flex: 1, minWidth: 0 }} />
                        </Tooltip>
                ...
                <Box className="tab-content" flex="1" overflow="auto">
                    ...
                    {tabIndex === 4 && <MapsManagement gameId={gameId} setFilePath={setFilePath} />}
                    {tabIndex === 5 && <GameManagement gameId={gameId} />}
                </Box>
            </Box>
        </Box>
    );
